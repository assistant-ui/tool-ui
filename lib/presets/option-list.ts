    ...
    data: {
      ...
      options: [
        ...
        },
        {
          id: "long-text",
          label:
            "Option with Very Long Label That Should Wrap or Truncate Gracefully",
          description:
            "This description is also quite long to test how the component handles text overflow and wrapping in both the label and description areas of an option item.",
        },
