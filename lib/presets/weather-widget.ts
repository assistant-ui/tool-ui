...
> = {
  ...
  "mixed-conditions": {
    description: "Variable weather with changing conditions",
    data: {
      id: "weather-widget-mixed-conditions",
      location: "London, UK",
      current: {
        temp: 14,
        tempMin: 11,
      ...
      forecast: [
        { day: "Mon", tempMin: 10, tempMax: 15, condition: "drizzle" },
        { day: "Tue", tempMin: 12, tempMax: 17, condition: "partly-cloudy" },
        { day: "Wed", tempMin: 9, tempMax: 14, condition: "overcast" },
        { day: "Thu", tempMin: 11, tempMax: 18, condition: "clear" },
        { day: "Fri", tempMin: 8, tempMax: 13, condition: "fog" },
      ],
      unit: "celsius",
    } satisfies SerializableWeatherWidget,
    generateExampleCode: generateWeatherWidgetCode,
