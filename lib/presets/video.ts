  ...
  "with-poster": {
    ...
    data: {
      video: {
        ...
        src: "https://videos.pexels.com/video-files/857251/857251-hd_1920_1080_25fps.mp4",
        poster: "https://images.unsplash.com/photo-1432405972618-c60b0225b8f9?w=900&auto=format&fit=crop",
        title: "Mountain Waterfall",
        description: "Crystal clear water cascading down mossy rocks.",
        ratio: "16:9",
        fit: "cover",
        durationMs: 10000,
        ...
        source: {
          label: "Pexels",
          iconUrl: "https://api.dicebear.com/7.x/shapes/svg?seed=pexels",
        },
      },
    } satisfies VideoData,
    generateExampleCode: generateVideoCode,
