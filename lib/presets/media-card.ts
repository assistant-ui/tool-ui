...
export const mediaCardPresetDescriptions: Record<MediaCardPresetName, string> =
  {
    ...
    video: "Video preview with thumbnail, duration, and media controls",
    audio: "Audio clip with poster artwork and duration metadata",
    link: "Rich link preview using OpenGraph data",
    actions: "Media with response action buttons and confirmation",
  };
