      ...
      <PopoverTrigger asChild>
        ...
        >
          <div className="flex items-center">
            {visibleCitations.map((citation, index) => {
              ...
              return (
                <div
                  key={citation.id}
                  className={cn(
                    "relative flex size-6 items-center justify-center rounded-full border border-background bg-muted",
                    index > 0 && "-ml-2",
                  )}
            ...
            {remainingCount > 0 && (
              <div
                className="-ml-2 relative flex size-6 items-center justify-center rounded-full border border-background bg-muted"
                style={{ zIndex: 0 }}
              >
