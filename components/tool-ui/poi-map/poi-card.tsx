  ...
  if (variant === "compact") {
    return (
      ...
      >
        ...
        <span className="mt-1.5 line-clamp-2 text-sm leading-snug font-medium tracking-tight">
          {poi.name}
        </span>
      ...
      <div className="flex min-w-0 flex-1 flex-col">
        ...
        {onViewDetails && (
          <Button
            variant="ghost"
            size="sm"
            className="text-muted-foreground hover:text-foreground active:scale-95 mt-1.5 h-8 gap-1.5 self-start rounded-lg px-2.5 text-xs transition-all"
            onClick={(e) => {
              e.stopPropagation();
