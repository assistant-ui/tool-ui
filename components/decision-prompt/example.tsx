...
export function DecisionPromptExample() {
  ...
  const [multiChoiceResult, setMultiChoiceResult] = useState<
    string | undefined
  >();
  const [destructiveResult, setDestructiveResult] = useState<
    string | undefined
  >();
    ...
    <div className="space-y-8 p-8">
      ...
      <section className="space-y-3">
        ...
        <p className="text-muted-foreground text-sm">
          Click &ldquo;Delete&rdquo; once to enter confirm state, then click
          &ldquo;Confirm delete&rdquo; to execute
        </p>
        <DecisionPrompt
      ...
      <section className="space-y-3">
        <h2 className="text-lg font-semibold">
          With Validation (onBeforeAction)
        </h2>
        <DecisionPrompt
