...
export function MockVariantEditor({
  ...
  const lastParsedRef = useRef<MockResponse>(variant.response);
  ...
  useEffect(() => {
    ...
    lastParsedRef.current = variant.response;
  }, [variant]);
  ...
  const handleSave = () => {
    ...
    onSave({
      ...
      type,
      delay,
      response: lastParsedRef.current,
    });
  };
      ...
      <div className="flex flex-col gap-3">
        <div className="flex gap-2">
          ...
          <div className="w-28">
            ...
            <Select value={type} onValueChange={(v) => setType(v as MockVariantType)}>
        ...
        <div>
          ...
          <div className="bg-input/50 overflow-hidden rounded-md border">
            <CodeMirror
              value={responseText}
              height="120px"
