...
export const SDK_DOCS_INDEX: DocChunk[] = [
  ...
  },
  {
    ...
    "content": "Many Apps SDK apps can operate in a read-only, anonymous mode, but anything that exposes customer-specific data or write actions should authenticate users.\n\nYou can integrate with your own authorization server when you need to connect to an existing backend or share data between users.",
    "keywords": [
      "apps",
      "data",
      "users",
  ...
  },
  {
    ...
    "content": "The host passes `locale` in `window.openai` and mirrors it to `document.documentElement.lang`. It is up to your widget to use that locale to load translations and format dates/numbers. A simple pattern with `react-intl`:\n\n```tsx\nconst messages: Record<string, Record<string, string>> = {\n  \"en-US\": en,\n  \"es-ES\": es,\n};\n\nexport function App() {\n  const locale = window.openai.locale ?? \"en-US\";\n  return {\n    /* Render UI with <FormattedMessage> or useIntl() */\n  };\n}\n```",
    "keywords": [
      "locale",
      "string",
      "window",
  ...
  },
  {
    ...
    "content": "In Apps SDK, tools are the contract between your MCP server and the model. They describe what the connector can do, how to call it, and what data comes back. Good tool design makes discovery accurate, invocation reliable, and downstream UX predictable.\n\nUse the checklist below to turn your use cases into well-scoped tools before you touch the SDK.",
    "keywords": [
      "sdk",
      "tools",
      "apps",
  ...
  },
  {
    ...
    "content": "This guide explains how to manage state for custom UI components rendered inside ChatGPT when building an app using the Apps SDK and an MCP server. You’ll learn how to decide where each piece of state belongs and how to persist it across renders and conversations.",
    "keywords": [
      "state",
      "guide",
      "explains",
  ...
  },
  {
    ...
    "content": "ChatGPT decides when to call your connector based on the metadata you provide. Well-crafted names, descriptions, and parameter docs increase recall on relevant prompts and reduce accidental activations. Treat metadata like product copy—it needs iteration, testing, and analytics.",
    "keywords": [
      "metadata",
      "chatgpt",
      "decides",
  ...
  },
  {
    ...
    "heading": "Goals",
    "content": "Testing validates that your connector behaves predictably before you expose it to users. Focus on three areas: tool correctness, component UX, and discovery precision.",
    "keywords": [
      "testing",
      "validates",
      "connector",
  ...
  },
  {
    ...
    "content": "When something goes wrong—components failing to render, discovery missing prompts, auth loops—start by isolating which layer is responsible: server, component, or ChatGPT client. The checklist below covers the most common problems and how to resolve them.",
    "keywords": [
      "something",
      "goes",
      "wrong",
  ...
  },
  {
    ...
    "content": "- **Ngrok tunnel times out** – restart the tunnel and verify your local server is running before sharing the URL. For production, use a stable hosting provider with health checks.\n- **Streaming breaks behind proxies** – ensure your load balancer or CDN allows server-sent events or streaming HTTP responses without buffering.",
    "keywords": [
      "tunnel",
      "server",
      "streaming",
  ...
  },
  {
    ...
    "heading": "Overview",
    "content": "Apps are developer-built experiences that are available in ChatGPT. They extend what users can do without breaking the flow of conversation, appearing through lightweight cards, carousels, fullscreen views, and other display modes that integrate seamlessly into ChatGPT’s interface.\n\nBefore you start designing your app visually, make sure you have reviewed our\nrecommended [UX principles](/apps-sdk/concepts/ux-principles).\n\n![Example apps in the ChatGPT mobile interface](/images/apps-sdk/overview.png)",
    "keywords": [
      "apps",
      "chatgpt",
      "interface",
  ...
  },
  {
    ...
    "content": "The `complete_checkout` tool call can send back [messages](https://developers.openai.com/commerce/specs/checkout#message-type--error) of type `error`. Error messages with `code` set to `payment_declined` or `requires_3ds` will be displayed on the Instant Checkout UI. All other error messages will be sent back to the widget as a response to `requestCheckout`. The widget can display the error as desired.",
    "keywords": [
      "error",
      "messages",
      "back",
  ...
  },
  {
    ...
    "content": "You can set the value of the `payment_mode` field to `test` in the call to `requestCheckout`. This will present an Instant Checkout UI that accepts test cards (such as the 4242 test card). The resulting `token` within `payment_data` that is passed to the `complete_checkout` tool can be processed in the staging environment of your PSP. This allows you to test end-to-end flows without moving real funds.\n\nNote that in test payment mode, you might have to set a different value for `merchant_id`. Refer to your PSP's monetization guide for more details.",
    "keywords": [
      "test",
      "set",
      "value",
