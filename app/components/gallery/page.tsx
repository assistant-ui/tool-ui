...
export default function ComponentsGalleryPage() {
  return (
    <div className="bg-background relative box-border flex h-full min-h-0 w-full max-w-6xl flex-col overflow-hidden rounded-lg rounded-tl-lg border-t border-l">
      ...
      <div className="scrollbar-subtle z-10 min-h-0 flex-1 overflow-auto overscroll-contain p-6 sm:p-10 lg:p-12">
        <div className="columns-1 gap-5 [column-fill:_balance] md:columns-2 2xl:columns-3 2xl:gap-5">
