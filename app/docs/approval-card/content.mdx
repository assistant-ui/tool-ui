...
```bash
npx shadcn@latest add --cwd <path-to-package-with-components-json> https://tool-ui.com/r/approval-card.json
```

This command installs `components/tool-ui/approval-card`, `components/tool-ui/shared`, and `lib/ui/cn.ts` into your project.
