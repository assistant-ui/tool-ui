...
```bash
npx shadcn@latest add --cwd <path-to-package-with-components-json> https://tool-ui.com/r/code-block.json
```

This command installs `components/tool-ui/code-block`, `components/tool-ui/shared`, and `lib/ui/cn.ts` into your project.
