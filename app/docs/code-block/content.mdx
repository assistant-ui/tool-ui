...
CodeBlock renders agent-produced code with syntax highlighting, line numbers, and a copy button. You can highlight specific lines to draw attention to changes or bugs, and long snippets auto-collapse so they do not overwhelm the conversation. Without it, code appears as unstyled monospace text.
...
<FeatureGrid>
  ...
  <Feature icon="FoldVertical" title="Collapsible mode">
    Long snippets auto-collapse to keep conversations scannable
  </Feature>
