...
<DocsHeader
  title="Code Block"
  description="A syntax-highlighted code display component with copy functionality and collapsible mode. Perfect for showing code snippets, examples, and technical content."
