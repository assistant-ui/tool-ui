        ...
        stats={[
          {
            ...
            sparkline: { data: [180, 210, 195, 240, 220, 260, 285], color: "var(--chart-1)" },
          },
          {
            key: "mrr",
...
- **Good for:** KPI dashboards, analytics summaries, performance snapshots
- **Not for:** Detailed data exploration (use [Data Table](/docs/data-table)), time-series visualization (use [Chart](/docs/chart))
