...
<div className="mt-8 grid gap-6 md:grid-cols-2">
  <MockThread caption="Without Tool UI">
    <MockMessage role="user">I want to understand how LLMs work. Where should I start?</MockMessage>
    <MockMessage role="assistant">
      <span className="text-foreground text-sm">
        {"Here are three solid paths depending on how you learn best:"}
      </span>
      <ol className="text-foreground text-sm mt-2 list-decimal space-y-1 pl-5">
        <li><strong>Visual intuition first</strong> — 3Blue1Brown + Karpathy's Zero to Hero. Watch, then build.</li>
        <li><strong>Code-first, build a transformer</strong> — Karpathy's nanoGPT walkthrough. Learn by implementing.</li>
        <li><strong>Textbook foundations</strong> — Jurafsky & Martin. Rigorous, math-heavy, thorough.</li>
      </ol>
      <span className="text-foreground text-sm mt-2 block">
        {"Which approach sounds right?"}
      </span>
    </MockMessage>
  </MockThread>
  ...
  <MockThread caption="With Tool UI">
    ...
    <MockMessage role="assistant">
      <span className="text-foreground text-sm">
        {"Here are three paths depending on how you learn best:"}
      </span>
      <div className="mt-3">
        <OptionList
          ...
          options={[
            { id: "visual", label: "Visual intuition first", description: "3Blue1Brown + Karpathy's Zero to Hero. Watch, then build." },
            { id: "code", label: "Code-first, build a transformer", description: "Karpathy's nanoGPT walkthrough. Learn by implementing." },
            { id: "textbook", label: "Textbook foundations", description: "Jurafsky & Martin. Rigorous, math-heavy, thorough." },
          ]}
        />
      </div>
    </MockMessage>
...
The left side ends with a question you have to type an answer to. The right side gives structured options you can click, and your choice feeds back to the assistant as a typed result.
