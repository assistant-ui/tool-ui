...
Tool UI is an open‑source library of [shadcn/ui](https://ui.shadcn.com)-inspired, copy-pasteable, single‑purpose UI components that an LLM can invoke—typically via tool call—during a conversation.
