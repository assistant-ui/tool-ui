...
_Define your tool with a serializable schema so LLM outputs stay predictable._
...
_Check for the tool output part, parse it, and render the component._
...
_Attach actions and handle them in your app so follow-up behavior stays under your control._
