...
<Alert className="squircle my-6 flex max-w-2xl flex-col gap-3 rounded-4xl border-emerald-950 bg-emerald-950/20 p-5">
  ...
  <AlertDescription className="my-0! py-0! text-pretty text-emerald-100">
    {
      "Tool UI is in active development. APIs are shifting as we refine patterns for conversation-native UIs. Since the components are copy paste, there's less concern about upstream churn."
    }
  </AlertDescription>
</Alert>
