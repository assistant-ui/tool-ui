...
Goals:
1) Re-install affected components to pull in the new compound subcomponent exports.
...
Steps:
- Run the following install commands to update each component:
  npx shadcn@latest add https://tool-ui.dev/r/code-block.json
  npx shadcn@latest add https://tool-ui.dev/r/terminal.json
  npx shadcn@latest add https://tool-ui.dev/r/order-summary.json
  npx shadcn@latest add https://tool-ui.dev/r/video.json
  npx shadcn@latest add https://tool-ui.dev/r/progress-tracker.json
  npx shadcn@latest add https://tool-ui.dev/r/item-carousel.json
