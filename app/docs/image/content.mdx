...
<FeatureGrid>
  <Feature icon="Image" title="Rich metadata">
    Display title, description, domain, and source attribution
  </Feature>
  <Feature icon="Maximize" title="Aspect ratio control">
    Support for common ratios: 1:1, 4:3, 16:9, 9:16
  </Feature>
  <Feature icon="Settings2" title="Response actions">
    Add download, share, or custom action buttons
  </Feature>
</FeatureGrid>
