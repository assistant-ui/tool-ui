...
- Hides unselected options and footer actions
...
Copy `components/tool-ui/option-list` into your project. The `tool-ui` directory should sit alongside your shadcn `ui` directory.
