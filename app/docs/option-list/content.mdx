...
<DocsHeader
  title="Option List"
  description="A decision surface for presenting single or multi-select choices."
...
- **Not for:** Long lists (use [Data Table](/docs/data-table)), complex multi-field forms, free-text input
