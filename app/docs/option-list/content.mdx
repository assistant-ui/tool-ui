...
```bash
npx shadcn@latest add --cwd <path-to-package-with-components-json> https://tool-ui.com/r/option-list.json
```

This command installs `components/tool-ui/option-list`, `components/tool-ui/shared`, and `lib/ui/cn.ts` into your project.
