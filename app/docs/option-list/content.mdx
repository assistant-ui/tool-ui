...
A decision surface for presenting single or multi-select choices. Optimized for inline selection prompts with confirmation and receipt states.
...
- **Not for:** Long lists (use Data Table), complex multi-field forms, free-text input
