...
<DocsHeader
  title="Terminal"
  description="Display command output display, with ANSI color support."
...
- **Not for:** Interactive terminal sessions (use [xterm.js](https://xtermjs.org/)), real-time log streaming, command input
