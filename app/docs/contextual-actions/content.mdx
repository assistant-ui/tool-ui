...
<Tabs items={["Preview", "Code"]}>
  <Tab>
    <div className="not-prose">
      <MediaCard
        surfaceId="contextual-actions-media-card"
        assetId="rsc-guide"
        kind="link"
