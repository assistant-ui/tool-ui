...
Platform-specific social media cards for X, LinkedIn, and Instagram. Each component matches native styling while adding interactive features for chat interfaces.
...
- **Not for:** Non-social content (use Media Card), dense event tables, editable rich text
