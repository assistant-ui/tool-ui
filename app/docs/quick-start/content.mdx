...
## Next steps
- Data table example with sorting and statuses: /docs/data-table
- Map errors with `toUIMessageStreamResponse({ onError })`
- Type tool parts in the UI with `InferUITools`
- Use Assistant‑UI + `AssistantChatTransport` to forward client tools/system
