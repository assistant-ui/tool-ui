...
<FeatureGrid>
  <Feature icon="Play" title="Native video controls">
    Play, pause, seek, and volume with native browser controls
  </Feature>
  <Feature icon="Image" title="Poster support">
...
- **Good for:** Video previews, demo recordings, media playback
- **Not for:** Audio content (use [Audio](/docs/audio)), image content (use [Image](/docs/image))
