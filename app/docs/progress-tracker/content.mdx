...
```bash
npx shadcn@latest add --cwd <path-to-package-with-components-json> https://tool-ui.com/r/progress-tracker.json
```

This command installs `components/tool-ui/progress-tracker`, `components/tool-ui/shared`, and `lib/ui/cn.ts` into your project.
