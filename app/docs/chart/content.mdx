...
```bash
npx shadcn@latest add --cwd <path-to-package-with-components-json> https://tool-ui.com/r/chart.json
```

This command installs `components/tool-ui/chart`, `components/tool-ui/shared`, and `lib/ui/cn.ts` into your project.
...
export const toolkit: Toolkit = {
  showChart: {
    ...
    render: createResultToolRenderer({
      safeParse: safeParseSerializableChart,
      render: (parsedResult) => (
        <>
            <Chart {...parsedResult} />
        </>
