...
```bash
npx shadcn@latest add --cwd <path-to-package-with-components-json> https://tool-ui.com/r/audio.json
```

This command installs `components/tool-ui/audio`, `components/tool-ui/shared`, and `lib/ui/cn.ts` into your project.
