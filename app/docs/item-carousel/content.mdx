...
<DocsHeader
  title="Item Carousel"
  description="A horizontal carousel for browsing collections of items."
...
- **Not for:** Long catalogs (use [Data Table](/docs/data-table)), single item details (use [Image](/docs/image) or [Link Preview](/docs/link-preview))
