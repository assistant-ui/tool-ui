...
```bash
npx shadcn@latest add --cwd <path-to-package-with-components-json> https://tool-ui.com/r/item-carousel.json
```

This command installs `components/tool-ui/item-carousel`, `components/tool-ui/shared`, and `lib/ui/cn.ts` into your project.
