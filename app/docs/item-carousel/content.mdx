...
<DocsHeader
  title="Item Carousel"
  description="A horizontal carousel for browsing collections of items. Optimized for surfacing recommendations and enabling comparison in chat interfaces."
...
- **Not for:** Long catalogs (use [Data Table](/docs/data-table)), single item details (use [Media Card](/docs/media-card))
...
Copy [`components/tool-ui/item-carousel`](https://github.com/assistant-ui/tool-ui/tree/main/components/tool-ui/item-carousel) and the [`shared`](https://github.com/assistant-ui/tool-ui/tree/main/components/tool-ui/shared) directory into your project. The `shared` folder contains utilities used by all Tool UI components.
