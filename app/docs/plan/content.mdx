...
- Progress bar fill turns emerald green
- Green checkmark appears in the card header (opposite the title)

This provides subtle positive feedback when a plan is fully executed.
