...
```bash
npx shadcn@latest add --cwd <path-to-package-with-components-json> https://tool-ui.com/r/image-gallery.json
```

This command installs `components/tool-ui/image-gallery`, `components/tool-ui/shared`, and `lib/ui/cn.ts` into your project.
