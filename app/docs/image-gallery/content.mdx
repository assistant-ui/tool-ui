...
<DocsHeader
  title="Image Gallery"
  description="Display multiple images in a masonry grid with fullscreen lightbox."
...
<FeatureGrid>
  ...
  <Feature icon="Maximize" title="Fullscreen lightbox">
    Click any image to view in a fullscreen lightbox
  </Feature>
  <Feature icon="Sparkles" title="Smooth transitions">
