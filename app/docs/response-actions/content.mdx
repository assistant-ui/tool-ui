...
Response Actions are lightweight CTAs for human-in-the-loop decision points. They let users respond to AI-generated content before it's finalized or acted upon.
...
### MediaCard: Generated Hero Image
...
Tab order matches visual order—keyboard users navigate left-to-right as expected.
