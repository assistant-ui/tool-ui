...
graph TD
    ...
    User -->|controls| Surface
    User -->|observes| Surface
    Surface <-->|mediates| Assistant
    Assistant -->|narrates| User

    style User fill:#3b82f6,stroke:#1d4ed8,color:#fff
    style Surface fill:#10b981,stroke:#047857,color:#fff
    style Assistant fill:#8b5cf6,stroke:#6d28d9,color:#fff
`} />

The assistant contextualizes, interprets, and narrates. The surface provides structure the assistant cannot render inline. They're complementary: surfaces shouldn't explain themselves, and assistants shouldn't render tables.
