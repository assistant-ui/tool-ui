...
<FeatureGrid>
  <Feature icon="Link" title="Rich link cards">
    Display OG image, title, description, and domain
  </Feature>
  <Feature icon="Globe" title="Favicon support">
    Show site favicon alongside domain name
  </Feature>
  <Feature icon="Settings2" title="Response actions">
    Add open, copy link, or custom action buttons
  </Feature>
</FeatureGrid>

## When to Use

- **Good for:** Link previews, article cards, URL references
- **Not for:** Image galleries (use [Image](/docs/image)), media playback (use [Video](/docs/video) or [Audio](/docs/audio))
