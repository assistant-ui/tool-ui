  ...
  <Tab>
    <div className="not-prose mx-auto max-w-md">
      <TimeSeries
        ...
        points={[
          { t: new Date(Date.now() - 6 * 86400000).toISOString(), v: 320 },
          { t: new Date(Date.now() - 5 * 86400000).toISOString(), v: 310 },
          { t: new Date(Date.now() - 4 * 86400000).toISOString(), v: 290 },
          { t: new Date(Date.now() - 3 * 86400000).toISOString(), v: 360 },
          { t: new Date(Date.now() - 2 * 86400000).toISOString(), v: 410 },
          { t: new Date(Date.now() - 1 * 86400000).toISOString(), v: 380 },
          { t: new Date().toISOString(), v: 330 },
        ]}
        baseline={[
          { t: new Date(Date.now() - 6 * 86400000).toISOString(), v: 300 },
          { t: new Date(Date.now() - 5 * 86400000).toISOString(), v: 295 },
          { t: new Date(Date.now() - 4 * 86400000).toISOString(), v: 285 },
          { t: new Date(Date.now() - 3 * 86400000).toISOString(), v: 300 },
          { t: new Date(Date.now() - 2 * 86400000).toISOString(), v: 305 },
          { t: new Date(Date.now() - 1 * 86400000).toISOString(), v: 298 },
          { t: new Date().toISOString(), v: 292 },
        ]}
        band={{
          label: "Expected",
          upper: [
            { t: new Date(Date.now() - 6 * 86400000).toISOString(), v: 360 },
            { t: new Date(Date.now() - 5 * 86400000).toISOString(), v: 350 },
            { t: new Date(Date.now() - 4 * 86400000).toISOString(), v: 330 },
            { t: new Date(Date.now() - 3 * 86400000).toISOString(), v: 390 },
            { t: new Date(Date.now() - 2 * 86400000).toISOString(), v: 420 },
            { t: new Date(Date.now() - 1 * 86400000).toISOString(), v: 400 },
            { t: new Date().toISOString(), v: 350 },
          ],
          lower: [
            { t: new Date(Date.now() - 6 * 86400000).toISOString(), v: 280 },
            { t: new Date(Date.now() - 5 * 86400000).toISOString(), v: 270 },
            { t: new Date(Date.now() - 4 * 86400000).toISOString(), v: 260 },
            { t: new Date(Date.now() - 3 * 86400000).toISOString(), v: 300 },
            { t: new Date(Date.now() - 2 * 86400000).toISOString(), v: 340 },
            { t: new Date(Date.now() - 1 * 86400000).toISOString(), v: 320 },
            { t: new Date().toISOString(), v: 300 },
          ],
        }}
        annotations={[{ t: new Date(Date.now() - 2 * 86400000).toISOString(), label: "Deploy" }]}
      />
    </div>
  </Tab>
  <Tab>
