...
|----------|----------------|
| **Size-aware** | Container queries at 280px, 400px, 560px breakpoints |
| **Live updating** | `refreshInterval` prop triggers `onRefresh` callback |
...
- [ ] Badge/highlight animations for new items
