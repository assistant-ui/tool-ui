...
InstagramPost renders a media-first card that matches Instagram's visual language: author info, image carousel, caption, and engagement stats. Use it when the assistant surfaces or drafts Instagram content and you want it displayed natively instead of as raw data.
