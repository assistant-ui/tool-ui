...
<DocsHeader
  title="Data Table"
  description="An information surface for tabular tool outputs with responsive layout, sorting, and declarative formatting."
...
- **Not for:** Single-record details (use [Media Card](/docs/media-card)), simple choice lists (use [Option List](/docs/option-list)), complex multi-step forms
