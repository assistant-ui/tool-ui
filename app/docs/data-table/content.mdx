...
## Source & install
Simply copy and paste `components/data-table` alongside to your shadcn/ui components dir, typically `components/ui`.
...
<TypeTable
  type={{
    ...
    "Row Type T": {
      ...
      typeDescriptionLink: "components/data-table/types.ts:35",
    },
    RowPrimitive: {
      description:
      ...
      typeDescriptionLink: "components/data-table/types.ts:34",
    },
  }}
/>
...
Full types: components/data-table/types.ts
