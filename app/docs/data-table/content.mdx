...
```bash
npx shadcn@latest add --cwd <path-to-package-with-components-json> https://tool-ui.com/r/data-table.json
```

This command installs `components/tool-ui/data-table`, `components/tool-ui/shared`, and `lib/ui/cn.ts` into your project.
...
export const toolkit: Toolkit = {
  searchProducts: {
    ...
    render: createResultToolRenderer({
      ...
      render: (parsedResult) => (
        <>
            <DataTable rowIdKey="id" {...parsedResult} />
        </>
      ),
    }),
  },
